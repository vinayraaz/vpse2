package in.varadhismartek.patashalaerp.PieChart;
...
public class PieChart extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                textColor = array.getColor(R.styleable.PieChart_text_color, Color.DKGRAY);
                ...
                textSize = array.getFloat(R.styleable.PieChart_text_size, 25f);
